...
export default function GetInTouch(props) {
  return (
    <button
      className={`get-in-touch ${props.styles} font-medium overflow-hidden flex items-center justify-center text-2xl -550:text-xl gap-4 text-grayBg bg-white rounded-[40px] p-2 pl-3`}
    >
